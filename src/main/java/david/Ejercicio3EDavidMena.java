 ...
 * @author david
 */
public class Ejercicio3EDavidMena {
        ...
        ||codProducto.equals("P1")){
           ...
           // Entrada de precio materia prima con JOption y lo pasamos a double
            ...
            if (materiaPrima>=LIMITE_INFERIOR && materiaPrima<=LIMITE_SUPERIOR){
                ...
                do {
                    coste_Mano_Obra = JOptionPane.showInputDialog(
                        "Introduce el coste de la mano de obra ");
                    costeManoObra = Double.parseDouble(coste_Mano_Obra);

                    } while (costeManoObra < MANO_OBRA_M1_T1
                        || costeManoObra > MANO_OBRA_M2_T2_P1);
